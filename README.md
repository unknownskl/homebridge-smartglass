...
2. Go to startup settings (.. -> ..) and add the 2 lines below

    apk add --no-cache python2 python2-dev py2-pip gcc
    pip install cryptography

3. Restart the HOOBS container (.. -> ..). This can take a couple minutes to come back. It will install all the required dependencies. (Up to 10 minutes, this is a one-time thing)
